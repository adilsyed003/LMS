...
import { Plus, X, GripVertical, Video, FileText, HelpCircle } from "lucide-react";
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
...
function SortableSection({ section, onUpdateSection, onDeleteSection }: {
      ...
      <CardContent>
        <div className="space-y-3">
          {section.lectures.map((lecture) => (
            <div key={lecture.id} className="flex items-center gap-3 p-3 border rounded">
